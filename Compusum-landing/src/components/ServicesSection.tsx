import { ArrowRight, Sun, Battery, Zap, Wrench, Shield, Settings } from "lucide-react";
...
const services = [
  {
    ...
    desc: "Diseño, instalación y puesta en marcha de sistemas de energía solar para reducir costos y proteger el medio ambiente.",
  },
  {
    image: serviceUps,
    icon: Battery,
    title: "Equipos de Protección",
    desc: "Venta y mantenimiento de UPS, inversores, reguladores de voltaje y estabilizadores de energía.",
  },
  {
    image: serviceElectrical,
    icon: Zap,
    title: "Instalaciones Eléctricas",
    desc: "Instalaciones eléctricas comerciales, industriales y residenciales con técnicos altamente calificados.",
  },
  {
    image: serviceMaintenance,
    icon: Wrench,
    title: "Mantenimiento General",
    desc: "Servicio preventivo y correctivo para equipos de protección de energía, baterías y sistemas eléctricos.",
  },
];
          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-muted-foreground font-body mb-5 leading-relaxed">{s.desc}</p>
                <a
